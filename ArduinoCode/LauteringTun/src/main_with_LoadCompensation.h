...
#define ledWaterDetectedPin 16 // red LED
#define ledWifiPin 27 //         blue LED
#define ledMqttPin 23 //         yellow LED
//rotary encoder
#define outputA 13 //pin 13 ESP32 - 
#define outputB 16 //pin 16 ESP32 - 
///Water indicator
#define waterDetectedPin 35
//-----------------------------------------------------------------------
//Settings
...
void publishMessage() 
{
  ...
  // --- Core readings ---
  doc["mashTemp"]      = roundTo(current_lauteringTemp, 6);  // 3 decimal
  ...
  // --- PID parameters ---
  doc["kp"]            = settings.Kp_lautering;
  doc["ki"]            = settings.Ki_lautering;
  ...
  client.publish(privates.topicState, buffer, n);

  // if (!writeInflux(current_lauteringTemp, DutyCycle / 4095.0f * 2500.0f)) {
